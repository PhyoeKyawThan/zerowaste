...
--
-- Host: localhost
-- Generation Time: Jul 25, 2025 at 10:33 PM
...
--
ALTER TABLE `admin`
  MODIFY `adm_id` int(222) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `users_claims`
  ADD CONSTRAINT `users_claims_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `users` (`u_id`),
  ADD CONSTRAINT `users_claims_ibfk_2` FOREIGN KEY (`d_id`) REFERENCES `dishes` (`d_id`);
COMMIT;
