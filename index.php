...
<section class="hero bg-image" data-image-src="images/img/bg.jpg">
    <div class="hero-inner">
        <div class="container text-center hero-text font-white">
            <h1>မဂ်လာပါ Zero Waste မှ ကြိုဆိုပါတယ်</h1>
            ...
            <div class="steps">
                <div class="step-item step1">
                    ...
                    <h4><span style="color:white;"></span>ဆိုင်ရွေးမယ်</h4>
                </div>
                ...
                <div class="step-item step2">
                    ...
                    <h4><span style="color:white;"></span>အော်ဒါ တင်မယ်</h4>
                </div>
                ...
                <div class="step-item step3">
                    ...
                    <h4><span style="color:white;"> </span>သွားယူကြမယ်</h4>
                </div>
            </div>
        </div>
    </div>
...
<section class="popular">
    <div class="container">
        <div class="title text-xs-center m-b-30">
            <h2>လူကြိုက်များသော အစားအစာများ</h2>
        <p class="lead">သင်အကြိုက်ဆုံး အစားအစာတွေကို အခုဘဲ မှာယူလိုက်ပါ</p>
        </div>
        <div class="row">
            <?php
            ...
            <div class="row how-it-works-solution">
                <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                    <div class="how-it-works-wrap">
                        <div class="step step-1">
                            ...
                            <h3>ဆိုင်ကို ရွေးပါ</h3>
                            <p>လျှော့ဈေးများစွာ ရှိသော ဆိုင်များမှ နှစ်သက်ရာဆိုင်ကို နှစ်သက်ရာဆိုင်ကို ရွေးချယ်ပါ</p>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                    <div class="step step-2">
                        ...
                        <h3>အော်ဒါ တင်ပါ</h3>
                        <p>နှစ်သက်ရာ အစားအသောက်ကို ရွေးချယ်၍ အော်ဒါ တင်နိုင်ပါတယ်</p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                    <div class="step step-3">
                        ...
                        <h3>ဆိုင်တွင် သွားယူပါ</h3>
                        <p>မိမိ မှာ ယူထားသော ဆိုင်တွင် သတ်မှတ်ထားသော အချိန်အတွင်း သွားရောက်ယူနိုင်ပါပြီ</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="title-block pull-left">
                    <h4>လျှော့ဈေးများစွာရှိသော ဆိုင်များ</h4>
                </div>
            </div>
